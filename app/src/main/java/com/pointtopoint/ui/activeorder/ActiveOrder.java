package com.pointtopoint.ui.activeorder;
...
import com.pointtopoint.ui.allorder.Allorder;
import com.pointtopoint.ui.allorder.DashboardViewModel;
...
public class ActiveOrder extends Fragment {
    ...
    private ActiveOrderViewModel mViewModel;
    ...
    public static ActiveOrder newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mViewModel =
                new ViewModelProvider(this).get(ActiveOrderViewModel.class);
        ...
        getData();
        search();
        return inflater.inflate(R.layout.active_order_fragment, container, false);
    }
